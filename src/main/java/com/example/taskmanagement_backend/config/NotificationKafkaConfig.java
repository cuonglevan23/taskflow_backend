...
/**
 * Kafka configuration for the notification system
 * Handles event streaming for chat messages and notifications
 */
@Slf4j
@Configuration
@EnableKafka
public class NotificationKafkaConfig {
    ...
    /**
     * Producer configuration for sending notification events
     */
    @Bean
    ...
    /**
     * Consumer configuration for receiving notification events
     */
    @Bean
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> notificationKafkaListenerContainerFactory() {
        ...
        factory.setConcurrency(3); // Process with 3 threads
